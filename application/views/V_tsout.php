<div class="container" style="margin-top: 25px;">
    <h3 class="alert alert-primary">Timbang Keluar</h3>
    <hr>
    <table class="table table-striped">
        <tbody>
            ...
            <form action="<?= base_url() ?>scan/tsout_ok" method="POST">
                <!-- waktu di security in -->
                <input type="hidden" name="id_barcode" id="id_barcode" value="<?php echo $id_barcode ?>">
                <input type="hidden" name="ts_out" id="ts_out" value="<?php date_default_timezone_set("Asia/Jakarta");
