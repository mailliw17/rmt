<div class="container" style="margin-top: 25px;">
    <h3 class="alert alert-primary">Timbang Masuk</h3>
    <hr>
    <table class="table table-striped">
        <tbody>
            ...
            <form action="<?= base_url() ?>scan/tsin_ok" method="POST">
                <!-- waktu di security in -->
                <input type="hidden" name="id_barcode" id="id_barcode" value="<?php echo $id_barcode ?>">
                <input type="hidden" name="ts_in" id="ts_in" value="<?php date_default_timezone_set("Asia/Jakarta");
